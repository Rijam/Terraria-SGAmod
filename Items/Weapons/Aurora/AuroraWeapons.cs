...
namespace SGAmod.Items.Weapons.Aurora
{
            ...
            if (!Main.dedServ)
            {
                ...
                Item.GetGlobalItem<ItemUseGlow>().CustomDraw = delegate (Item item, PlayerDrawInfo drawInfo, Vector2 position, float angle, Color glowcolor)
                {
                    ...
                    if (true)
                    {
                        ...
                        {
                            DrawData value2 = new DrawData(texture, drawHere + (i + Main.GlobalTimeWrappedHourly).ToRotationVector2() * 0.20f, null, SkyLightColors[drawPlayer.SGAPly().skylightLightInfused.Item2] * skylightInfuse * itemalpha * 0.02f, MathHelper.PiOver4 + (drawInfo.drawPlayer.direction < 0 ? MathHelper.PiOver2 : 0) + angle, origin, 1f, drawInfo.spriteEffects, 0);
                        ...
                        for (float a = 4f; a < 16f; a += 2f)
                        {
                            ...
                            {
                                float randomier = (float)Math.Sin(Main.GlobalTimeWrappedHourly * rando.NextFloat(-MathHelper.Pi * 0.5f, MathHelper.Pi * 0.5f)) * rando.NextFloat(-MathHelper.Pi * -0.05f, MathHelper.Pi * 0.05f);
                                DrawData value2 = new DrawData(texture, drawHere + (angle.ToRotationVector2() * a) + (i + Main.GlobalTimeWrappedHourly * 2f).ToRotationVector2(), null, SkyLightColors[drawPlayer.SGAPly().skylightLightInfused.Item2] * skylightInfuse * itemalpha * 0.05f, MathHelper.PiOver2 + angle + randomier, new Vector2(0, 0) + texture.Size() / 2f, new Vector2(0.75f, 1.25f), drawInfo.spriteEffects, 0);
                                Main.playerDrawData.Add(value2);
                            }
                        }
                    }
    ...
    public class SkylightChargeUpProj : ModProjectile, IDrawAdditive
    {
        ...
        public void DrawAdditive(SpriteBatch spriteBatch)
        {
            ...
            {
                rots.Add(((f + (Main.GlobalTimeWrappedHourly* rando.NextFloat(0.75f, 2f))) % 1f, rando.NextFloat(MathHelper.TwoPi) + (Main.GlobalTimeWrappedHourly * rando.NextFloat(-1f, 1f) * 0.01f)));
            }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            TrailHelper trail = new TrailHelper("BasicEffectAlphaPass", ModContent.Request<Texture2D>("SGAmod/TrailEffect"));
            //trail.projsize = projectile.Hitbox.Size() / 2f;
            trail.coordOffset = new Vector2(0, Main.GlobalTimeWrappedHourly * 8f);
        ...
        public class SkylightSlashProj : ModProjectile,IDrawAdditive, ITrueMeleeProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                SoundEngine.PlaySound(SoundID.NPCHit, (int)Projectile.Center.X, (int)Projectile.Center.Y, 5, 0.25f, -0.85f);
            }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            trail = new TrailHelper("BasicEffectAlphaPass", ModContent.Request<Texture2D>("SGAmod/TrailEffect"));
            //trail.projsize = projectile.Hitbox.Size() / 2f;
            ...
            {
                trail = new TrailHelper("BasicEffectDarkPass", ModContent.Request<Texture2D>("SGAmod/TrailEffect"));
                //trail.projsize = projectile.Hitbox.Size() / 2f;
                trail.coordOffset = new Vector2(0, Main.GlobalTimeWrappedHourly * -12f);
                trail.coordMultiplier = new Vector2(1f, 1f);
        ...
        public class TheNorthernShine : ModItem,IAuroraItem
    {
        ...
        public override void AddRecipes()
        {
            CreateRecipe(1).AddIngredient(ItemID.LunarFlareBook, 1).AddIngredient(ModContent.ItemType<AuroraTearAwoken>(), 1).AddIngredient(ModContent.ItemType<IlluminantEssence>(), 10).AddIngredient(ItemID.LunarBar, 8).AddIngredient(ItemID.ShinePotion, 1).AddTile(ModContent.TileType<LuminousAlter>()).Register();
        }
    }
    ...
    public class FireFoxGreatbow : ModItem, IAuroraItem
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            var snd = SoundEngine.PlaySound(SoundID.DD2_BetsyFireballShot, (int)position.X, (int)position.Y);
            if (snd != null)
            {
                snd.Pitch = 0.75f;
            }
        ...
        public override void AddRecipes()
        {
            CreateRecipe(1).AddIngredient(ItemID.Phantasm, 1).AddIngredient(ModContent.ItemType<HavocGear.Items.Weapons.MangroveBow>(), 1).AddIngredient(ModContent.ItemType<AuroraTearAwoken>(), 1).AddIngredient(ModContent.ItemType<IlluminantEssence>(), 12).AddIngredient(ItemID.LunarBar, 8).AddIngredient(ItemID.ArcheryPotion, 1).AddTile(ModContent.TileType<LuminousAlter>()).Register();
    ...
    public class FireFoxProj : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            TrailHelper trail = new TrailHelper("FadedRainbowEffectPass", ModContent.Request<Texture2D>("SGAmod/TiledPerlin"));
            ...
            trail.rainbowCoordOffset = new Vector2((Main.GlobalTimeWrappedHourly + Projectile.whoAmI) * 0.05f, Main.GlobalTimeWrappedHourly * -1.25f);
            trail.rainbowCoordMultiplier = new Vector2(0.5f, 1.25f);
            trail.rainbowColor = new Vector3((Main.GlobalTimeWrappedHourly+(Projectile.whoAmI*7.173f)) / 3f, 0.32f, 0.75f);
            ...
            TrailHelper foxtailtrail = new TrailHelper("FadedRainbowEffectPass", ModContent.Request<Texture2D>("SGAmod/Stain"));
            ...
            foxtailtrail.rainbowCoordOffset = new Vector2(0, Main.GlobalTimeWrappedHourly * -0.360f);
            foxtailtrail.rainbowCoordMultiplier = new Vector2(0.05f, 0.25f);
            foxtailtrail.rainbowColor = new Vector3((Main.GlobalTimeWrappedHourly + (Projectile.whoAmI * 7.173f)) / 3f, 0.250f, 0.75f);
            foxtailtrail.rainbowTexture = ModContent.Request<Texture2D>("SGAmod/TiledPerlin");

            foxtailtrail.color = delegate (float percent)
            {
                float percet = (((percent/2f) + Projectile.whoAmI*0.73983f) - (Main.GlobalTimeWrappedHourly/5f));
            ...
            hallowed.Parameters["overlayProgress"].SetValue(new Vector3(0, (-Main.GlobalTimeWrappedHourly+Projectile.whoAmI) / 1f, (Main.GlobalTimeWrappedHourly+ Projectile.whoAmI*7.31f
                ) / 4f));
    ...
    public class PolarityHalberd : ModItem, IAuroraItem
    {
        ...
        public override void AddRecipes()
        {
            CreateRecipe(1).AddIngredient(ItemID.NorthPole, 1).AddIngredient(ModContent.ItemType<AuroraTearAwoken>(), 1).AddIngredient(ModContent.ItemType<IlluminantEssence>(), 12).AddIngredient(ItemID.LunarBar, 8).AddIngredient(ItemID.NightOwlPotion, 1).AddTile(ModContent.TileType<LuminousAlter>()).Register();
            CreateRecipe(1).AddIngredient(ItemID.MonkStaffT3, 1).AddIngredient(ModContent.ItemType<AuroraTearAwoken>(), 1).AddIngredient(ModContent.ItemType<IlluminantEssence>(), 8).AddIngredient(ItemID.LunarBar, 6).AddIngredient(ItemID.NightOwlPotion, 1).AddTile(ModContent.TileType<LuminousAlter>()).Register();
    ...
    public class PolarityHalberdProj : ModProjectile,ITrueMeleeProjectile
    {
        ...
        public void SwapAttack(int type,Vector2 velocity = default)
        {
            ...
            if ((Projectile.ai[0] < 1 || (type < 50 && comboHits > 0)) || type == 0)
            {
                ...
                if (doit)
                {
                    ...
                    comboState += 1;
                    SoundEffectInstance sound = SoundEngine.PlaySound(SoundID.DD2_SkyDragonsFurySwing, (int)Projectile.Center.X, (int)Projectile.Center.Y);
                    if (sound != null)
                    {
                        sound.Pitch = 0.80f;
                    }
        ...
        public void SwapWeaponMode()
        {
            ...
            {
                weaponMode += 1;
                SoundEffectInstance sound = SoundEngine.PlaySound(SoundID.DD2_MonkStaffSwing, (int)Projectile.Center.X, (int)Projectile.Center.Y);
                if (sound != null)
                {
                    sound.Pitch = 0.75f;
                }
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            SoundEffectInstance sound = SoundEngine.PlaySound(SoundID.DD2_MonkStaffGroundImpact, (int)Projectile.Center.X, (int)Projectile.Center.Y);
            if (sound != null)
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            trail = new TrailHelper("FadedRainbowEffectPass", SGAmod.Instance.Assets.Request<Texture2D>("TiledPerlin").Value);
            trail.coordMultiplier = new Vector2(0.25f, 1f);// projectile.velocity.Length());
            trail.coordOffset = new Vector2(0, Main.GlobalTimeWrappedHourly * -1f);
            trail.trailThickness = 12;
            ...
            trail.rainbowCoordOffset = new Vector2(Main.GlobalTimeWrappedHourly*0.05f, Main.GlobalTimeWrappedHourly * -1.25f);
            trail.rainbowCoordMultiplier = new Vector2(0.5f, 1.25f);
            trail.rainbowColor = new Vector3(Main.GlobalTimeWrappedHourly / 3f, 1f, 0.75f);
            trail.rainbowTexture = SGAmod.Instance.Assets.Request<Texture2D>("TiledPerlin").Value;

            trail.DrawTrail(oldFrontSwings.Select(testby => new Vector3(testby.Item1.X, testby.Item1.Y, 0)).ToList(), Projectile.Center);


            trail = new TrailHelper("FadedBasicEffectPass", SGAmod.Instance.Assets.Request<Texture2D>("SmallLaser").Value);
            ...
            if (LaserAlpha >= 0)
            {
                ...
                for (int i = 0; i < 2; i += 1)
                {
                    ...
                    TrailHelper connect = new TrailHelper("BasicEffectAlphaPass", SGAmod.Instance.Assets.Request<Texture2D>("SmallLaser").Value);
                    connect.coordMultiplier = new Vector2(1f, 1.25f);// projectile.velocity.Length());
                    connect.coordOffset = new Vector2(Main.rand.NextFloat(-1f, 1f) * 0.025f, Main.GlobalTimeWrappedHourly * -1f);
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            hallowed.Parameters["prismColor"].SetValue(Color.White.ToVector3());
            hallowed.Parameters["overlayProgress"].SetValue(new Vector3(0, -Main.GlobalTimeWrappedHourly / 1f, (Main.GlobalTimeWrappedHourly) / 4f));
    ...
    public class AuraBeamStikeProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (timer == ExplodeTime)
            {
                SoundEffectInstance sound = SoundEngine.PlaySound(SoundID.NPCHit, (int)Projectile.Center.X, (int)Projectile.Center.Y, 52);
                if (sound != null)
                {
                    sound.Pitch = 0.75f;
                }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            {
                sploderEffect.Add(((i / 10f) + (Main.GlobalTimeWrappedHourly * 3f)) % 1f);
            }
    ...
    public class SkyeHook : ModItem, IAuroraItem
    {
        ...
        public override void AddRecipes()
        {
            CreateRecipe(1).AddIngredient(ItemID.LunarHook, 1).AddIngredient(ModContent.ItemType<AuroraTearAwoken>(), 1).AddIngredient(ModContent.ItemType<OverseenCrystal>(), 20).AddIngredient(ModContent.ItemType<IlluminantEssence>(), 12).AddTile(ModContent.TileType<LuminousAlter>()).Register();
    ...
    public class SkyeHookProjectile : ModProjectile
    {
            ...
            if (Projectile.ai[1] == 0)
            {
                ...
                else
                {
                    if (Projectile.ai[0] != 1)
                    {
                        if (Projectile.ai[0] < 3)
                        {
                            var snd = SoundEngine.PlaySound(SoundID.DD2_BallistaTowerShot, (int)Projectile.Center.X, (int)Projectile.Center.Y);
                            if (snd != null)
                            {
                                snd.Pitch = 0.90f;
                            }
            ...
            else
            {
                ...
                if (Projectile.ai[0] == 5)
                {
                    ...
                    if (percent2 >= 1f)
                    {
                        ...
                        var snd = SoundEngine.PlaySound(SoundID.DD2_BetsyFireballImpact, (int)Projectile.Center.X, (int)Projectile.Center.Y);
                        if (snd != null)
                        {
                            snd.Pitch = -0.75f;
                        }
        ...
        {
            Player player = Main.player[Projectile.owner];
            TrailHelper trail = new TrailHelper("FadedRainbowEffectPass", ModContent.Request<Texture2D>("SGAmod/SmallLaser"));
            ...
            trail.rainbowCoordOffset = new Vector2((Main.GlobalTimeWrappedHourly + Projectile.whoAmI) * 0.05f, Main.GlobalTimeWrappedHourly * -1.25f);
            trail.rainbowCoordMultiplier = new Vector2(0.5f, 1.25f);
            trail.rainbowColor = new Vector3((Main.GlobalTimeWrappedHourly + (Projectile.whoAmI * 7.173f)) / 3f, 0.5f, 0.75f);
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            if (Projectile.ai[0] == 5 || Projectile.ai[0] == 6)
            {
                ...
                if (Projectile.ai[1] == 1)
                {
                    ...
                    RadialEffect.Parameters["texOffset"].SetValue(new Vector2(-Main.GlobalTimeWrappedHourly * 0.375f, -Main.GlobalTimeWrappedHourly * 0.275f));
                    ...
                    RadialEffect.Parameters["overlayTexture"].SetValue(SGAmod.Instance.Assets.Request<Texture2D>("Stain").Value);
                    RadialEffect.Parameters["texOffset"].SetValue(new Vector2(0.50f+ Main.GlobalTimeWrappedHourly * 0.375f, -Main.GlobalTimeWrappedHourly * 0.275f));
                    ...
                    SGAmod.SphereMapEffect.Parameters["mappedTextureOffset"].SetValue(new Vector2(-Main.GlobalTimeWrappedHourly * 1f, 0f));
                    ...
                    SGAmod.SphereMapEffect.Parameters["mappedTextureOffset"].SetValue(new Vector2(-Main.GlobalTimeWrappedHourly * 1.25f,0f));
                    ...
                    noise = ModContent.Request<Texture2D>("SGAmod/Voronoi");
                    ...
                    SGAmod.SphereMapEffect.Parameters["mappedTextureOffset"].SetValue(new Vector2(-Main.GlobalTimeWrappedHourly * 1.15f, 0f));
