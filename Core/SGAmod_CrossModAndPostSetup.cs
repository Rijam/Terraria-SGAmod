	...
	public partial class SGAmod : Mod
	{
		...
		public override void PostSetupContent()
		{
			...
			if (bossList != null)
			{
				...
				bossList.Call("AddBoss", 16f, ModContent.NPCType<SPinky>(), this, "Supreme Pinky", (Func<bool>)(() => SGAWorld.downedSPinky), new List<int>() { ModContent.ItemType<Prettygel>() }, new List<int>() { SGAmod.Instance.ItemType("SupremePinkyTrophy"), ModContent.ItemType<SupremePinkyMask>(), SGAmod.Instance.ItemType("MusicBox_SupremePinky"), ModContent.ItemType<MonarchicalCate>() }, SPinkyDrops, "Use a [i:" + ItemType("Prettygel") + "] at night, infuse 20 [i: " + ItemID.PinkGel + "] at a [i: " + ModContent.ItemType<LuminousAlterItem>() + "]", "Supreme Pinky is content with the justice they have dealt");
				...
				bossList.Call("AddBoss", 17.5f, ModContent.NPCType<Hellion>(), this, "Helon 'Hellion' Weygold", (Func<bool>)(() => SGAWorld.downedHellion > 1), new List<int>() { ModContent.ItemType<HellionSummon>() }, new List<int>() { SGAmod.Instance.ItemType("HellionTrophy"), SGAmod.Instance.ItemType("MusicBox_Hellion") }, moaritems, "Craft & Use the [i:" + ModContent.ItemType<HellionSummon>() + "]. Equip the [i:" + ModContent.ItemType<DevPower>() + "] to unlock the 2nd phase (Expert Only)", "...", "SGAmod/NPCs/Hellion/Hellion", "SGAmod/NPCs/Hellion/Hellion_map_icon", (Func<bool>)(() => SGAWorld.downedHellion != 0));
