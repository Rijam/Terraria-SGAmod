...
{
	public class PrismicVisitant : ModProjectile
	{
		...
		{
			Player player = Main.player[Projectile.owner];
			if (player.HasBuff(ModContent.BuffType<Buffs.Pets.PrismicVisitantBuff>()))
			{
				Projectile.timeLeft = 2;
			}
			Lighting.AddLight(Projectile.Center, 0.25f, 0.0f, 0.25f);
